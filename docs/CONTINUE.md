...
> The nail diagram shows mixed magnetic regions while OFF; after ON, a distinct
> current-circulation arrow and axial magnetic-field arrow accompany alignment.
> Preserve reversal, visible compass readings, clip attraction/release, the
> summary and all three applications highlighted together for 11 seconds.
> Use the included videos and packed scenes for previews; do not render or request
> speech again unless relevant content changes. Check status before assuming
> an export, test or deployment completed. Summarize the current checkpoint and
> ask what I want to change next. Keep code modular, science accurate, public
> files professional, third-party licences intact and handoff documentation current.
